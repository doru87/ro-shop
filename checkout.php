...
<div class="container">
    ...
    <div class="col-md-2 mt-5"></div>
        ...
        if(isset($_SESSION['id_utilizator'])){
            ...
            $result = query("SELECT * FROM utilizatori WHERE id_utilizator='$id_utilizator'");
            ...
            while($utilizator = fetch_array($result)){
                ...
                <h3>Customer Shipping Details</h3>				
                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6"> 
                                <input class="btn btn-primary" type="submit" name="proceedPayment" value="Continuati sa platiti"/>
                            </div>
                        </div>
                    </form>					
                </div>';
                ...
                if(isset($_POST['cost_total']) && isset($_POST['cost_total']) && isset($_POST['cost_livrare'])){
                    ...
                    && isset($_POST['contactNumber']) && isset($_POST['emailAddress'])){
                        ...
                        <div class="col-md-2 checkout-details">
                            ...
                            <form class="form-horizontal" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="POST">
                                ...
                                <input type="hidden" name="notify_url" value="localhost/ro-shop/notify.php">
                                <input type="hidden" name="return" value="localhost/ro-shop/success.php">
                                <input type="hidden" name="cmd" value="_xclick"> 
                                <input type="hidden" name="order" value="">
                                <br>
                                
                                <div class="col-12"> 
                                    <input type="submit" class="btn btn-sm btn-block btn-danger" name="continue_payment" value="Plateste acum">				 
                                </div>
